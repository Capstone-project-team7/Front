  ...
  const [colDefs, setColDefs] = useState([
    ...
    { headerName: 'IP 주소', field: 'ip_address', flex: 1 },
    {
      ...
      cellRenderer: (params) => {
        ...
        return (
          <button
            className={`${styles.activatebtn} ${isActive ? styles.active : styles.inactive}`}
    ...
    },
    {
      ...
      cellRenderer: (params) => {
        const row = params.data;
        return <CommonButton label="수정" size="small" color="secondary" onClick={() => handleEditCCTV(row)} />;
      }, // 커스텀 렌더러 사용
      sortable: false,
      filter: false,
    },
    ...
    <div className={styles.cctvpage}>
      <div className={styles.cctvpage__wrapper}>
        ...
        <div className={styles.cctvpage__wrapper__content}>
          <span className={styles.cctvpage__wrapper__content__subtitle}>등록된 CCTV</span>
          ...
          <div className={styles.cctvpage__wrapper__content__table} style={{ height: 400, width: '100%' }}>
            <AgGridReact
              ref={gridRef}
              rowData={rowData}
              columnDefs={colDefs}
