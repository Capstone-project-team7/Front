...
import { faHouseChimney, faCalendar, faVideo, faFileLines, faGear } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <li className={`${styles.menuitem} ${isActive ? styles.selected : ''}`}>
      <Link id={idtype} className={styles.menuitem__link} to={to}>
        ...
        <span className={styles.menuitem__link__label}>{label}</span>
      </Link>
    </li>
  );
}
